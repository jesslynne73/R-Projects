...
(A) .Rmd Line number(s) for general data wrangling: Lines 66-70, 90-96


(B) .Rmd Line number(s) for a join operation: Lines 54-58
...
(E) .Rmd Line number(s) for use of reduction and/or transformation functions: Lines 60-64
...
(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): Lines 79-87
