...
```
Looking at these maps allows us to visualize my overarching research question. We have done the wrangling, and here is what we've learned: now, let's show which continents are happiest so the next researcher doesn't have to 
