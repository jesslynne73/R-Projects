...
(A) .Rmd Line numbers where at least two different data sources are imported: Lines 27-37


(B) .Rmd Line numbers for inspecting data intake: Lines 39-46
...
(A) .Rmd Line number(s) for general data wrangling: Lines 63-67, 86-89, 92-98, 111-112


(B) .Rmd Line number(s) for a join operation: Lines 51-55
...
(E) .Rmd Line number(s) for use of reduction and/or transformation functions: Lines 57-61, 77, 86-87, 95
...
(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): Line 79
...
(A) .Rmd Line number(s) for use of multiple different geoms: Line 127, 134

(B) .Rmd Line number(s) for use of multiple aesthetics: Line 127, 134

(C) .Rmd Line number(s) for use of layered graphics: N/A

(D) .Rmd Line number(s) for use of leaflet maps: No leaflet maps but WorldMap() visualizations on Lines 140 and 144

(E) .Rmd Line number(s) for use of decision tree or dendogram results: Lines 118-121
