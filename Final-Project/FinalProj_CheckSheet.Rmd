...
(A) .Rmd Line number(s) for use of multiple different geoms: Line 127 

(B) .Rmd Line number(s) for use of multiple aesthetics: Line 127

(C) .Rmd Line number(s) for use of layered graphics: N/A

(D) .Rmd Line number(s) for use of leaflet maps: No leaflet maps but WorldMap() visualizations on Lines 133 and 137
